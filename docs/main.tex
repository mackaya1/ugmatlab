...
\begin{tcolorbox}[title=Task]
  ...
  \end{lstlisting}
  \tcblower
  \textit{Extension:} Extend the program so that it reproduces the game "Fizzbuzz". Have the code display the word "Fizz" when it encounters a multiple of 3, "Buzz" on a multiple of 5 and "FizzBuzz" on a multiple of both 3 and 5.
\end{tcolorbox}
